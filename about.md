...
[**Brilliant Scape**](https://briscape.com)は、読んだ本の断片、選挙やスポーツ、街のこと、生成 AI とコードのこと——題材は一定せず、書きたくなったことを日本語で並べています。ときには作家や作品名が顔を出し、ときには日記のようにあります。全体としては、紙の雑誌ではなく、自分の机の上に置いたノートに近い場所を目指しています。

文体は、かつての文豪の文章をモデルにして生成しています。生成 AI と、そのモデルとした文豪のセンスを拝借しつつも、書かれているのは私の体験、想い、意見です。モデルとなった作家の作品そのものではありません。
